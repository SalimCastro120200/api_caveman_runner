import { createPlayer, deletePlayerByID, findAllPlayers, findPlayerByID, findPlayerByNickname, login, updatePlayer } from '../controllers/player.js';
...
router.get( "/player/whois/:gamertag",findPlayerByNickname )
